...
public final class FastJsonUtils {
	...
	public static JSONObject toJSONObject(String text, String field) {
	 ...
	 * @return
	 */
	public static JSONArray toJSONArray(String text, String field) {
		JSONObject jsonObject = JSON.parseObject(text);
		return JSONArray.parseArray(jsonObject.getString(field));
	}
	...
	public static <T> Map<String, T> toMapObj(String json, Class<T> clazz) {
	...
	public static <T> Map<String, List<T>> toMapList(String json, Class<T> clazz) {
		return JSON.parseObject(json, new TypeReference<Map<String, List<T>>>() {
		});
	}
